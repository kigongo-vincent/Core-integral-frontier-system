"""
Django settings for CIFS_API project.
...
SECRET_KEY = 'django-insecure-2s#)hvj2hf7#c8%(=mf(!zqdia8nq!w&*qqhsm1c!=mx5rebx_'
...
WSGI_APPLICATION = 'CIFS_API.wsgi.application'
